...
const Contact = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (!validateForm()) return setSubmitStatus('error');
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ name: '', email: '', phone: '', business: '', businessType: '' });
        setTimeout(() => {
      ...
      setSubmitStatus('error');
      setErrors({
        general: err.message.includes("reCAPTCHA") ?
      ...
      <div className="interconecta-container">
        <div className="interconecta-contact-wrapper">
          ...
          <div className="interconecta-contact-content">
            ...
            <h2 className="interconecta-contact-title">
              Tu asistente médico IA puede empezar esta semana
            </h2>
            <p className="interconecta-contact-description">
              Deja que un sistema automatizado capture pacientes por ti. Agenda una demo gratuita y descubre cómo.
            </p>
            <div className="interconecta-contact-benefits">
              <div className="interconecta-benefit-item">
                <div className="interconecta-benefit-icon"><span className="interconecta-benefit-icon-inner">✓</span></div>
                <p>Diagnóstico sin costo</p>
              </div>
              <div className="interconecta-benefit-item">
                <div className="interconecta-benefit-icon"><span className="interconecta-benefit-icon-inner">✓</span></div>
                <p>Implementación en 7 días</p>
              </div>
              <div className="interconecta-benefit-item">
                <div className="interconecta-benefit-icon"><span className="interconecta-benefit-icon-inner">✓</span></div>
                <p>ROI en el primer mes</p>
              </div>
               {/* Mensajes flotantes de impulso */}
               <div className="interconecta-floating-message">
                  <div className="interconecta-floating-bubble">📲 Agenda tu demo en menos de 1 minuto</div>
                  <div className="interconecta-floating-bubble">🤖 Tu asistente IA puede empezar este lunes</div>
                </div>
            </div>
          </div>
          ...
          <div className="interconecta-contact-form-wrapper">
            {!formSubmitted ? (
                ...
                <form className="interconecta-contact-form" onSubmit={handleSubmit}>
                  ...
                  <div className="interconecta-form-group">
                    ...
                    <input id="name" name="name" type="text" placeholder="Tu nombre"
                      ...
                      className={errors.name ? 'interconecta-input-error' : ''} disabled={isLoading}
                    />
                  ...
                  <div className="interconecta-form-group">
                    ...
                    <input id="email" name="email" type="email" placeholder="correo@ejemplo.com"
                      ...
                      className={errors.email ? 'interconecta-input-error' : ''} disabled={isLoading}
                    />
                  ...
                  <div className="interconecta-form-group">
                    ...
                    <input id="phone" name="phone" type="tel" placeholder="Ej. 5512345678"
                      value={formData.phone} onChange={handleChange}
                      className={errors.phone ? 'interconecta-input-error' : ''} disabled={isLoading}
                    />
                    {errors.phone && <small className="interconecta-error-msg">{errors.phone}</small>}
                  </div>

                  <div className="interconecta-form-group">
                    <label htmlFor="business">Nombre de tu clínica o consultorio</label>
                    <input id="business" name="business" type="text" placeholder="Tu negocio"
                      value={formData.business} onChange={handleChange}
                      className={errors.business ? 'interconecta-input-error' : ''} disabled={isLoading}
                    />
                  ...
                  <div className="interconecta-form-group">
                    ...
                    <select id="businessType" name="businessType"
                      ...
                      className={errors.businessType ? 'interconecta-input-error' : ''} disabled={isLoading}
                    >
                  ...
                  <div className="interconecta-form-group">
                    <button
                      ...
                      disabled={isLoading}
                    >
                      {isLoading ? (<><span className="interconecta-spinner"></span>Enviando...</>) : 'Solicitar demo'}
                    </button>
                  </div>
                  ...
                  <p className="interconecta-privacy-note">
                    Este sitio está protegido por reCAPTCHA y se aplican la <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Política de privacidad</a> y los <a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer">Términos de servicio</a> de Google.
                  </p>
                </form>
              </>
            ) : (
              <div className="interconecta-form-success">
                ...
                <h3>¡Demo solicitada con éxito!</h3>
                <p>Te contactaremos en menos de 24 horas. Gracias por confiar en Interconecta.</p>
                <button
                  onClick={() => {
                    setFormSubmitted(false);
                    setSubmitStatus(null);
